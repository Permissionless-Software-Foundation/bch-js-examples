...
library and the [bch-api](https://api.fullstack.cash/) REST API, offered by
...
to [join our Telegram channel](https://t.me/permissionless_software).
...
- [bch-js Documentation](https://fullstack.cash/documentation/)
...
2. [Fund it with the testnet faucet](https://developer.bitcoin.com/faucets/bch)
...
to test their software, and avoid the disruptions on testnet.
